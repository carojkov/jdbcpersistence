...
public class InsertGenerator implements Generator, Constants
{
  ...
  public InsertGenerator(MappedClass mappedClass,
  ...
  public void generateBody()
  {
    ...
    if (PersistorGenerator.hasLobColumns(_mappedClass)) {
    ...
    mw.visitLdcInsn(SqlStatementFactory.makeInsert(_mappedClass));
    ...
    int columnIndex = 0;
    MappedClass.MappedAttribute[] columns = _mappedClass.getColumns();
